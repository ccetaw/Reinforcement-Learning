...
for _ in tqdm(range(15000), desc="n_buttons=5, mode=all_exclu"):
    ...
    for i in range(100):  
        ...
        while not env.done:
            ...
            sum_jerk += env.add['move_time']
    idx = np.nonzero(best_10_ui > sum_jerk)[0]
    if len(idx) != 0:
        idx = idx[0]
        best_10_ui[idx] = sum_jerk
        env.save('./best_ui/n_buttons_5-mode_all_exclu_top'+str(idx))
print(best_10_ui)
